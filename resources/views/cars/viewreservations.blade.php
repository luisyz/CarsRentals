...
$costocalc=function($difdias, $costoe1, $costoe2, $costoe3, $costom, $isA, $difloc)
{
...
<table class="reservations" name="reservations">
  ...
  <tr>
    ...
    <td>${{$costocalc($difdias, $costoe1, $costoe2, $costoe3, $costom, $isA, $difloc)}}</td>
    <?php
    $ex="extra";
    for($i=1;$i<=3;$i++){
    if($_SESSION[$ex.$i]>0){
...
<input type="hidden" name="cost" value="{{$costocalc($difdias, $costoe1, $costoe2, $costoe3, $costom, $isA, $difloc)}}">
